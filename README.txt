...
-Jupyter notebook used for reference while writing the report
  -medical.ipynb - Token analysis for medical domain
  -se.ipynb - Token analysis for Software Engineering domain
  -sg_law.ipynb - Token analysis for Law domain
  -pair_ranker.ipynb - Pair Ranker for 3.2
  -for 3.3.ipynb - Application for 3.3
...
-Crawler scripts
  -software_engineering.py - Crawls data for Software Engineering
  -statues.py - Crawls data for Law
  -statues2.py - Cleans data for Law
...
Sample Outputs
image (Screenshot 1) - Outputs from POS Tagging for Medical Domain

image (Screenshot 2) - Outputs from {Noun-Adjective} Pair Ranker

image (Screenshot 3) - Outputs from Sentiment Analysis Application